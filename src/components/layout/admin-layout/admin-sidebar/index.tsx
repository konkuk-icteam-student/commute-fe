...
export default function AdminSidebar({ pathname }: { pathname: string }) {
  return (
    <aside className="sticky top-0 z-0 h-screen w-65 shrink-0 border-r-[0.5px] [border-right-width:0.5px] border-[#DDE3EF] bg-white px-8 pt-6.5 shadow-[0_1px_2px_0_rgba(0,0,0,0.25)] min-[1728px]:w-77 min-[1728px]:px-10.75 min-[1728px]:pt-20">
