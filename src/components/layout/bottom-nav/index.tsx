...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-50 mx-auto h-20 w-full max-w-150 rounded-t-[20px] border-solid border-[#DDE3EF] bg-white px-6.5 py-4 [border-width:0.5px_0.5px_0_0.5px]">
